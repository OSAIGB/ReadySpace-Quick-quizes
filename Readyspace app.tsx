                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                                {subjects.map((subject) => (
                                    <button
                                        ...
                                        className={`p-6 rounded-2xl border transition-all text-left group relative overflow-hidden ${subject === 'English' || subject === 'Math' || subject === 'Physics'
                                                ? 'bg-white border-stone-200 hover:border-emerald-500 hover:shadow-md'
                                                : 'bg-stone-100 border-stone-200 opacity-60 cursor-not-allowed'
                                            }`}
                                    >
                                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 transition-colors ${subject === 'English' || subject === 'Math' || subject === 'Physics' ? 'bg-emerald-50 text-emerald-600 group-hover:bg-emerald-600 group-hover:text-white' : 'bg-stone-200 text-stone-400'
                                            }`}>
